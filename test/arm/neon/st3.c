...
test_simde_vst3_f32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_float32x2x3_t a = simde_vld3_f32(test_vec[i].r);
...
test_simde_vst3_f64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_float64x1x3_t a = simde_vld3_f64(test_vec[i].r);
...
test_simde_vst3_s8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int8x8x3_t a = simde_vld3_s8(test_vec[i].r);
    int8_t r_[3][8];
    simde_vst3_s8(r_, a);
...
test_simde_vst3_s16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int16x4x3_t a = simde_vld3_s16(test_vec[i].r);
    int16_t r_[3][4];
    simde_vst3_s16(r_, a);
...
test_simde_vst3_s32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int32x2x3_t a = simde_vld3_s32(test_vec[i].r);
    int32_t r_[3][2];
    simde_vst3_s32(r_, a);
...
test_simde_vst3_s64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int64x1x3_t a = simde_vld3_s64(test_vec[i].r);
    int64_t r_[3][1];
    simde_vst3_s64(r_, a);
...
test_simde_vst3_u8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint8x8x3_t a = simde_vld3_u8(test_vec[i].r);
    uint8_t r_[3][8];
    simde_vst3_u8(r_, a);
...
test_simde_vst3_u16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint16x4x3_t a = simde_vld3_u16(test_vec[i].r);
    uint16_t r_[3][4];
    simde_vst3_u16(r_, a);
...
test_simde_vst3_u32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint32x2x3_t a = simde_vld3_u32(test_vec[i].r);
    uint32_t r_[3][2];
    simde_vst3_u32(r_, a);
...
test_simde_vst3_u64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint64x1x3_t a = simde_vld3_u64(test_vec[i].r);
    uint64_t r_[3][1];
    simde_vst3_u64(r_, a);
...
test_simde_vst3q_f32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_float32x4x3_t a = simde_vld3q_f32(test_vec[i].r);
    simde_float32_t r_[3][4];
    simde_vst3q_f32(r_, a);
...
test_simde_vst3q_f64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_float64x2x3_t a = simde_vld3q_f64(test_vec[i].r);
    simde_float64_t r_[3][2];
    simde_vst3q_f64(r_, a);
...
test_simde_vst3q_s8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int8x16x3_t a = simde_vld3q_s8(test_vec[i].r);
    int8_t r_[3][16];
    simde_vst3q_s8(r_, a);
...
test_simde_vst3q_s16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int16x8x3_t a = simde_vld3q_s16(test_vec[i].r);
    int16_t r_[3][8];
    simde_vst3q_s16(r_, a);
...
test_simde_vst3q_s32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int32x4x3_t a = simde_vld3q_s32(test_vec[i].r);
    int32_t r_[3][4];
    simde_vst3q_s32(r_, a);
...
test_simde_vst3q_s64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_int64x2x3_t a = simde_vld3q_s64(test_vec[i].r);
    int64_t r_[3][2];
    simde_vst3q_s64(r_, a);
...
test_simde_vst3q_u8 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint8x16x3_t a = simde_vld3q_u8(test_vec[i].r);
    uint8_t r_[3][16];
    simde_vst3q_u8(r_, a);
...
test_simde_vst3q_u16 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint16x8x3_t a = simde_vld3q_u16(test_vec[i].r);
    uint16_t r_[3][8];
    simde_vst3q_u16(r_, a);
...
test_simde_vst3q_u32 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint32x4x3_t a = simde_vld3q_u32(test_vec[i].r);
    uint32_t r_[3][4];
    simde_vst3q_u32(r_, a);
...
test_simde_vst3q_u64 (SIMDE_MUNIT_TEST_ARGS) {
  ...
  for (size_t i = 0 ; i < (sizeof(test_vec) / sizeof(test_vec[0])) ; i++) {
    simde_uint64x2x3_t a = simde_vld3q_u64(test_vec[i].r);
    uint64_t r_[3][2];
    simde_vst3q_u64(r_, a);
